...
void sendByte (unsigned char b) {
    ...
    if (b & 0b10000000) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b01000000) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00100000) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00010000) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00001000) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000100) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000010) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
    if (b & 0b00000001) { RC3=1; __nop(); __nop(); __nop(); RC3=1; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; } else { RC3=1; __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop(); RC3=0; __nop(); __nop(); __nop(); __nop();; }
